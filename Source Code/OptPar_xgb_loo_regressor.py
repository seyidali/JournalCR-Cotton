# -*- coding: utf-8 -*-
"""
Created on Friday 1 March 2021
...
input_filename = 'CottonData_Code(AB).xlsx'
output_filename = 'output_xgb_AB(SC).txt'
...
eta = [0.1, 0.3]
gamma = [0, 0.1]                # important
importance_type = ['gain']

learning_rate = [0.3, 0.01]
#learning_rate = [0.3, 0.001]    # learning_rate = [0.3, 0.01]

max_delta_step = [0, 10]        # optional (default = 0)
max_depth = [5, 6]              # important
min_child_weight = [1, 4]       # important

n_estimators = [256]            
#n_estimators = [500, 1000]      # 256 is ok

objective = ['reg:squarederror']
reg_alpha = [0]

reg_lambda = [1]
#reg_lambda = [0.1, 1]           # 1 is ok

scale_pos_weight = [1]
#scale_pos_weight = [1, 3]       # 1 is ok

subsample = [0.5]
#subsample = [0.5, 0.7]          # 0.5 is ok
